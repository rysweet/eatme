...
| Import/export | `starter-project-open-save-export-preflight` | Student opens a starter project, saves it, exports it, and verifies the exported artifact. | Partial: desktop launch/log/window/screenshot/readiness evidence is covered; missing save/export artifact verification | Covered: web open, save, reopen, and export project evidence is covered; desktop starter-gallery selection is not claimed |
