...
eatme alice discover --alice-home ${ALICE_HOME:-/path/to/alice3-modernization} --json
eatme alice package --alice-home ${ALICE_HOME:-/path/to/alice3-modernization} --offline --json
eatme alice launch-smoke \
  --alice-home ${ALICE_HOME:-/path/to/alice3-modernization} \
