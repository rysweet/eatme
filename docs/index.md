...
| Reviewing the planned first-lesson evidence boundary contract | [First-Lesson Evidence Readiness](first-lesson-evidence-readiness.md) |
...
Review the planned conservative first-lesson evidence boundary contract:
