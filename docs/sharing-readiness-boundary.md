...
Older PR-body claims tied to a previous head must be ignored or superseded by a
timestamped current-head comment or body update before they can support
readiness.
