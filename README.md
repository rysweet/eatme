...
curriculum scenarios against LookingGlass's REST API, covering 28
curriculum workflows plus separate save/reopen/export parity checks for scene building, procedures, events, loops,
