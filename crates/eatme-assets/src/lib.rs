...
pub use instructor_acceptance::{
    InstructorAgenticAcceptanceReport, InstructorAgenticOutput, InstructorAgenticProbeResult,
    generate_instructor_agentic_acceptance_output,
};
...
mod tests {
    ...
    fn validates_committed_assets() {
        ...
        assert!(report.passed, "{:?}", report.errors);
        assert_eq!(report.scenario_asset_count, 115);
    }
