...
fn validate_launch_smoke_boundary_claims(scenario: &EatmeScenarioAsset, errors: &mut Vec<String>) {
...
pub(super) fn scenario_contains_all_boundary_phrases(
    scenario: &EatmeScenarioAsset,
    phrases: &[&str],
) -> bool {
...
pub(super) fn scenario_has_unqualified_automated_grading_claim(
    scenario: &EatmeScenarioAsset,
) -> bool {
