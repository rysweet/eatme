...
fn student_artifact_package_share_evidence_contract_names_review_handoff_boundary() {
    ...
    assert_contains_all(
        ...
        &[
            ...
            "Readiness impact says the instructor gets a classroom/review handoff and the student produces an evidence package, not proof that deployed sharing works.",
