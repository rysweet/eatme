use super::types::{Blocker, Decision, ReadinessEvidence, ReadinessReport};
use super::{EVIDENCE_SCHEMA_VERSION, ReadinessOutcome};

pub(crate) fn evaluate_readiness(evidence: &ReadinessEvidence) -> ReadinessOutcome {
    ...
    ReadinessOutcome {
        report: ReadinessReport {
            ...
            no_op_justification: no_op_justification(evidence, decision),
            blockers,
        },
        exit_code,
    }
