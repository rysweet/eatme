...
fn explicit_rabbithole_boundary_evidence_is_reported_without_cross_claims() {
  ...
  "evidence_boundaries":[
    ...
    {"id":"save_project","status":"present","source":"rabbithole","metadata_state":"observed","artifact":{"path":"run-window-evidence/save-project-completion.json"},"detail":"Save scenario evidence is present.","claim":"Save action evidence is present for this scenario boundary.","does_not_prove":["grading","creative assessment","first-lesson completion"]},
