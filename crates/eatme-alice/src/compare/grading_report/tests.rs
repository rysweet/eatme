...
pub(super) fn find_step<'a>(report: &'a FirstLessonGradingReport, id: &str) -> &'a GradingStep {
    report
        .steps
        .iter()
        .find(|s| s.id == id)
...
pub(super) fn empty_readiness_report() -> LessonSessionReadinessReport {
...
pub(super) fn readiness_with_all_evidence() -> LessonSessionReadinessReport {
...
pub(super) fn test_boundary(id: &str, status: &str) -> FirstLessonEvidenceBoundary {
