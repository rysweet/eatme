...
pub struct FirstLessonReadinessSequenceReport {
    ...
    pub diagnostics: Vec<super::ContractDiagnostic>,
    pub contract_evidence: Vec<super::ContractEvidenceItem>,
...
pub fn run_first_lesson_readiness_sequence(
    ...
    Ok(FirstLessonReadinessSequenceReport {
        ...
        diagnostics: readiness.diagnostics.clone(),
        contract_evidence: readiness.contract_evidence.clone(),
        target_statuses,
